...
job_type :honeybadger_wrapped_jruby_script,
         'cd :path && :environment_variable=:environment TRAJECT_ENV=:traject_env /usr/local/rvm/bin/rvm jruby-9.4.2.0 do bundle exec honeybadger exec -e :environment::traject_env -q script/:task'
