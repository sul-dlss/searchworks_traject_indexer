...
job_type :honeybadger_wrapped_ruby_script,
         'cd :path && :environment_variable=:environment TRAJECT_ENV=:traject_env /usr/local/rvm/bin/rvm ruby-3.3.1 do bundle exec honeybadger exec -e :environment::traject_env -q script/:task'
