...
RSpec.describe Traject::Macros::Cocina do
  ...
  describe 'stacks_file_url' do
    ...
    context 'with file objects' do
      let(:accumulator) { record.filesets.first.files }
  ...
  describe 'find_file' do
    ...
    context 'with a mime type' do
      # mock structural for an object with a tiff, geotiff and COG
      let(:body) do
        {
          'structural' => {
            'contains' => [
