  ...
  describe 'title_uniform_search' do
    ...
    context 'linked fields' do
      ...
      it '240 are not included' do
        ...
        expect(select_by_id('240VernSearch')[field]).not_to eq %w[vern240a
                                                                  vern240d
                                                                  vern240f
                                                                  vern240g
                                                                  vern240k
