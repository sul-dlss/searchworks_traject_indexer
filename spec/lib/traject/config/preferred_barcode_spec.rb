...
RSpec.describe 'All_search config' do
  ...
  context 'with lc untruncated + dewey truncated' do
    let(:index_items) do
      [
        build(:lc_holding, barcode: 'LCbarcode', call_number: 'QE538.8 .N36', enumeration: '1975-1977'),
  ...
  describe 'prefers the shorted non-truncated callnumber' do
    context 'with lc only' do
      let(:index_items) do
        [
          build(:lc_holding, barcode: '666', call_number: 'QE538.8 .N36', enumeration: '1975-1977'),
          build(:lc_holding, barcode: '777', call_number: 'D764.7 .K72', enumeration: '1990')
        ]
      end
