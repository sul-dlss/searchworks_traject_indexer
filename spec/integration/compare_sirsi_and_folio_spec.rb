...
RSpec.describe 'comparing against a well-known location full of documents generated by solrmarc', if: ENV['OKAPI_URL'] || ENV['DATABASE_URL'] do # rubocop:disable Style/FetchEnvVar
  before do
