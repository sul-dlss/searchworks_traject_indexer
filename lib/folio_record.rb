...
class FolioRecord
  ...
  # since FOLIO Bound-with records don't have items, we generate a FolioHolding using data from the parent item and child holding,
  # or, if there is no parent item, we generate a stub FolioHolding from the original bound-with holding.
