...
class SirsiHolding
  ...
  SKIPPED_LOCS = %w[3FL-REF-S BASECALNUM BENDER-S BORROWDIR CDPSHADOW DISCARD DISCARD-NS EAL-TEMP-S
  ...
  def initialize(call_number:, home_location:, library:, barcode:, tag: nil, scheme: nil, current_location: nil,
